...
また、本発表は世の中の常識や、海外の常識を伝えるものではありません。あくまで僕の出した一つの「答案」をもとに、聞いてくれる人の周囲を見直すキッカケにしてもらうものです。
  ...
  そのため, ｢PerlでInfrastructure as Code｣と言われると, ｢え!! PerlでInfrastructure as Codeを!?｣と思われる方も多いのではないかと思います。<br /><br />
      ...
      <tr>
        ...
        <td>
            ...
            <ul>
              ...
              <li>刈川 陽平 （サイボウズ株式会社）<br />「プロトタイプで自社サービスをKAIZENした話」</li>
      ...
      <tr>
        ...
        <td>
            ...
            <ul>
              ...
              <li>與那城 雄<br />「普通の子(?)がエンジニア的になるまで」</li>
              <li>上川 慶<br />「合宿で作ったもの(仮)」</li>
            </ul>
      ...
      <tr class="track-break">
        ...
        <td>
          <p class="track-title"><i class="fa fa-coffee"></i> コーヒータイム</p>
